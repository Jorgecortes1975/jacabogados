...
- **Field data (CrUX, p75)** is what Google actually ranks on. Source it from the PageSpeed Insights API (`loadingExperience`) or the CrUX History API (Tier 1, free key).
