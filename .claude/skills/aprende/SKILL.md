...
`references/signal-patterns.md` (multi-language) **and, in this repo, also
`references/signal-patterns-juridico.md`** — legal-domain signals that override
the default confidence bands and carry a hard confidentiality rule. The
high-signal classes:
...
- `references/signal-patterns-juridico.md` — **JA Abogados**: señales del despacho (correcciones normativas, alucinación jurídica, competencia y plazos, preferencias de redacción) + la regla dura de confidencialidad de datos de clientes.
